...
const WAVE_PRESETS: Record<WaveVariant, { viewBox: string; layers: WaveLayer[] }> = {
  ...
  'blog-to-contact': {
    ...
    layers: [
      {
        path: 'M0,40 C360,80 720,30 1080,60 C1260,72 1380,55 1440,40 L1440,120 L0,120 Z',
        fill: 'var(--color-wave)',
      },
      {
        path: 'M0,65 C480,40 960,75 1440,55 L1440,120 L0,120 Z',
        fill: 'var(--color-wave-dark)',
        opacity: 0.6,
      },
      {
        path: 'M0,85 C360,70 720,90 1080,80 C1260,75 1380,85 1440,80 L1440,120 L0,120 Z',
        fill: 'var(--color-wave-dark)',
        opacity: 0.3,
      },
    ],
